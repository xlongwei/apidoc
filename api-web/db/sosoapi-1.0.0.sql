...
-- Records of t_inter
-- ----------------------------
INSERT INTO `t_inter` VALUES ('1', '2016-10-18 17:00:00', '2016-10-18 17:00:00', '1', '2', '新增用户(自定义参数)', '/user/complex/add.htm', 'POST', null, null, '新增用户(自定义参数)', 'application/json', 'application/json', '0', '0');
INSERT INTO `t_inter` VALUES ('2', '2016-10-18 17:00:01', '2016-10-18 17:00:01', '1', '2', '查询用户列表(多层嵌套)', '/user/complex/list.htm', 'GET', null, null, '查询用户列表(多层嵌套)', 'application/json', 'application/json', '0', '0');
INSERT INTO `t_inter` VALUES ('3', '2016-10-18 17:00:01', '2016-10-18 17:00:01', '1', '2', '获取用户详情(多层嵌套)', '/user/complex/{userId}/info.htm', 'GET', null, null, '获取用户详情(多层嵌套)', 'application/json', 'application/json', '0', '0');
INSERT INTO `t_inter` VALUES ('4', '2016-10-18 17:00:01', '2016-10-18 17:00:01', '1', '1', '新增用户', '/user/simple/add.htm', 'POST', null, null, '新增用户信息', 'application/json', 'application/json', '0', '0');
INSERT INTO `t_inter` VALUES ('5', '2016-10-18 17:00:01', '2016-10-18 17:00:01', '1', '1', '查询用户列表', '/user/simple/list.htm', 'GET', null, null, '获取用户列表', 'application/json', 'application/json', '0', '0');
INSERT INTO `t_inter` VALUES ('6', '2016-10-18 17:00:01', '2016-10-18 17:00:01', '1', '1', '删除用户', '/user/simple/{userId}/del.htm', 'DELETE', null, null, '删除指定用户', 'application/json', 'application/json', '0', '0');
